...
public class MiscAdapter extends RecyclerView.Adapter <MiscAdapter.myHolder> {

    private Context context;

    private List <Miscellaneous> datas;

    public MiscAdapter(Context context, List<Miscellaneous> datas) {
    ...
    public void onBindViewHolder(final myHolder holder, int position) {
        Miscellaneous productData = datas.get(position);
